...
<!--
	...
	Created by B.L. Choy (blchoy.hko@gmail.com).  First created on 29 March 2016.  Last updated on 23 October 2018.
...
Section 4.3.6.6a</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AerodromeRecentWeather']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='SeaSurfaceState']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='RunwayDeposits']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
Table 3700</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='RunwayContamination']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
Section 4.1.5.2b 1)</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AerodromePresentWeather']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='RunwayFrictionCoefficient']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
"PROB40 TEMPO"</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:sequence/xs:element[@name='NO_CHANGE']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:attribute[@name='NO_CHANGE']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:sequence/xs:element[@name='WEAKEN']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:attribute[@name='WEAKEN']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:sequence/xs:element[@name='INTENSIFY']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ExpectedIntensityChangeType']//xs:attribute[@name='INTENSIFY']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
...
The expected end of occurrence of volcanic ash ("NO VA EXP") is indicated with a missing SIGMET phenomenon with a nil reason of nothingOfOperationalSignificance</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='SIGMETType']//xs:sequence/xs:element[@name='analysis']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='SIGMETType']//xs:attribute[@name='analysis']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">A SIGMET report may include a phenomenon covering more than one area within the FIR/UIR/CTA.  This translates into observed and forecast conditions for each of these reported areas.  All combinations of observations and forecasts of meteorological conditions, including changing conditions, are represented by their own SIGMETEvolvingCondition.
...
Each analysis has a single SIGMETEvolvingConditionCollection as its result.  </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='SIGMETType']//xs:sequence/xs:element[@name='forecastPositionAnalysis']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='SIGMETType']//xs:attribute[@name='forecastPositionAnalysis']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">A forecast of the phenomenon at the end of the valid period.  This is modeled by SIGMETPosition for individual area of the phenomenon and aggregated into a single SIGMETPositionCollection as a result to forecastPositionAnalysis.</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AeronauticalSignificantWeatherPhenomenon']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">This element refers to the expected direction of movement which the phenomenon is moving towards, .e.g, "moving east". When no movement is expected, this is a http://www.opengis.net/def/nil/OGC/0/inapplicable nilReason and the speedOfMotion will be 0.
...
This element value is given in degrees from true North. Plane angle unit of measure (uom) is "deg". </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The expected speed of movement of a meteorological condition. When no movement is expected, this will have a value of 0 and directionOfMotion will have a http://www.opengis.net/def/nil/OGC/0/inapplicable nilReason.
...
speedOfMotion can be provided in either two units of measures: "km/h" or "[kn_i]" (knots).
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETEvolvingConditionCollectionType']//xs:sequence">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="element">
            <xsl:attribute name="name">
            ...
            <xsl:element name="annotation">
               <xsl:element name="documentation">
                  <xsl:value-of select="'Extension block for optional and/or additional parameters for element TropicalCycloneSIGMETEvolvingConditionCollection'"/>
               </xsl:element>
            </xsl:element>
         </xsl:element>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETEvolvingConditionCollectionType']//xs:sequence/xs:element[@name='tropicalCyclonePosition']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETEvolvingConditionCollectionType']//xs:attribute[@name='tropicalCyclonePosition']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The position of a tropical cyclone</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETEvolvingConditionCollectionType']//xs:sequence/xs:element[@name='tropicalCycloneId']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETEvolvingConditionCollectionType']//xs:attribute[@name='tropicalCycloneId']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The ID of the relevant tropical cyclone</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='VolcanicAshSIGMETEvolvingConditionCollectionType']//xs:sequence/xs:element[@name='volcanoId']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='VolcanicAshSIGMETEvolvingConditionCollectionType']//xs:attribute[@name='volcanoId']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The ID of the relevant erupting volcano</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='VolcanicAshSIGMETPositionCollectionType']//xs:sequence/xs:element[@name='volcanoId']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='VolcanicAshSIGMETPositionCollectionType']//xs:attribute[@name='volcanoId']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETPositionCollectionType']//xs:sequence">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="element">
            <xsl:attribute name="name">
            ...
            <xsl:element name="annotation">
               <xsl:element name="documentation">
                  <xsl:value-of select="'Extension block for optional and/or additional parameters for element TropicalCycloneSIGMETPositionCollection'"/>
               </xsl:element>
            </xsl:element>
         </xsl:element>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETPositionCollectionType']//xs:sequence/xs:element[@name='tropicalCyclonePosition']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETPositionCollectionType']//xs:attribute[@name='tropicalCyclonePosition']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETPositionCollectionType']//xs:sequence/xs:element[@name='tropicalCycloneId']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='TropicalCycloneSIGMETPositionCollectionType']//xs:attribute[@name='tropicalCycloneId']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='WeatherCausingVisibilityReduction']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The expected direction of movement of a meteorological condition. When no movement is expected, this is a http://www.opengis.net/def/nil/OGC/0/inapplicable nilReason and the speedOfMotion will be 0.  Direction of motion to shall be given in degrees from true North. Plane angle unit of measure (uom) is "deg".</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The expected speed of movement of a meteorological condition. When no movement is expected, this will have a value of 0 and directionOfMotion will have a http://www.opengis.net/def/nil/OGC/0/inapplicable nilReason. Speed of movement shall be given in either "km/h" or "[kn_i]" (knot).</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
Appendix 6 Section 2.1</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AeronauticalAreaWeatherPhenomenon']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
When no subsequent advisory is expected to be issued it should be indicated by a missing expected advisory time with a nil reason of 'inapplicable'</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The movement direction observed.  Only reported when the tropical cyclone is moving at least 6 km/hour or 3 knots. Direction of movement shall be given in degrees from true North. Plane angle unit of measure (uom) is "deg".</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">The movement speed observed.  Only reported when the tropical cyclone is moving at least 6 km/hour or 3 knots.  Speed of movement shall be provided in either two units of measures: "km/h" or "[kn_i]" (knot).</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AviationColourCode']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
      ...
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
            <xsl:element name="documentation">Elevation of a summit.

Summit elevation shall be reported either in meters ("m") or feet ("[ft_i]").</xsl:element>
         </xsl:element>
      </xsl:element>
   </xsl:template>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
When no subsequent advisory is expected to be issued it should be indicated by a missing expected advisory time with a nil reason of 'inapplicable'
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='SpaceWeatherLocation']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='SpaceWeatherPhenomena']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
When no subsequent advisory is expected to be issued it should be indicated by a missing expected advisory time with a nil reason of 'inapplicable'
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='AerodromeForecastWeather']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='SigConvectiveCloudType']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:element[@name='CloudAmountReportedAtAerodrome']"/>
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
...
Measured cloud bases shall be reported in meters ("m") or feet ("[ft_i]").</xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:sequence/xs:element[@name='reportStatus']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:attribute[@name='reportStatus']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:sequence/xs:element[@name='permissibleUsage']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:attribute[@name='permissibleUsage']">
      <xsl:element name="{local-name()}">
         <xsl:attribute name="use">
            <xsl:value-of select="'required'"/>
         </xsl:attribute>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:sequence/xs:element[@name='permissibleUsageReason']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:attribute[@name='permissibleUsageReason']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:sequence/xs:element[@name='permissibleUsageSupplementary']">
      <xsl:param name="typeName" select="@type"/>
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
      </xsl:element>
   ...
   <xsl:template xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 match="xs:complexType[@name='ReportType']//xs:attribute[@name='permissibleUsageSupplementary']">
      <xsl:element name="{local-name()}">
         <xsl:apply-templates select="@*|node()"/>
         <xsl:element name="annotation">
